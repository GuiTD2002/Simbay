    ...
    nodes = [
        ...
        Node(
            ...
            parameters=[
                controllers_yaml,
                {'robot_description': robot_description},
                #{'robot_description_source': 'parameter'},
        ...
        Node(
            ...
            #arguments=['jacobian_velocity_controller'],
            #arguments=['simple_torque_controller'],
            #arguments=['torque_controller_wj'],
